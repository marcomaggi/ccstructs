...
/* Initialisation  function  that  initialises  an already  allocated  struct.   This
   ...
   deserialisation.. */
cclib_decl void ccname_init(my_coords_t, deserialisable) (my_coords_t * S)
  CCLIB_FUNC_ATTRIBUTE_NONNULL(1);
...
cclib_decl void ccname_final(my_coords_t) (my_coords_t const * S CCNAMES_UNUSED)
  CCLIB_FUNC_ATTRIBUTE_NONNULL(1);
...
cclib_decl void ccname_delete(my_coords_t) (my_coords_t const * S)
  CCLIB_FUNC_ATTRIBUTE_NONNULL(1);
...
cclib_decl ccstructs_dtor_T ccname_trait_new(ccstructs_dtor_T, my_coords_t, embedded) (my_coords_t const * self)
  CCLIB_FUNC_ATTRIBUTE_NONNULL(1);

/* Constructor for a "ccstructs_dtor_T"  trait that destroys standalone instances
   dynamically allocated on the heap. */
cclib_decl ccstructs_dtor_T ccname_trait_new(ccstructs_dtor_T, my_coords_t, standalone) (my_coords_t const * self)
  CCLIB_FUNC_ATTRIBUTE_NONNULL(1);
