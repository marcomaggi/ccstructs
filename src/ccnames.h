...
/* Given   a  struct   type  name   and  a   (possibly  empty)   variant
   specification:   expand   into  the   name   of   the  API   function
   "delete()". */
#define CCNAME_DELETE(STRUCT_TYPE, VARIANT)	STRUCT_TYPE ## __ ## VARIANT ## __delete
...
/* Given   a  struct   type  name   and  a   (possibly  empty)   variant
   specification: expand into the name of the API function "final()". */
#define CCNAME_FINAL(STRUCT_TYPE, VARIANT)	STRUCT_TYPE ## __ ## VARIANT ## __final
...
#define CCNAME_IFACE_TABLE(IFACE_TYPE, STRUCT_TYPE, VARIANT)	\
  CCNAME_TABLE(IFACE_TYPE ## __ ## STRUCT_TYPE)
...
#define CCNAME_IFACE_METHOD(IFACE_TYPE, STRUCT_TYPE, VARIANT, METHOD_NAME)	\
  IFACE_TYPE ## __ ## STRUCT_TYPE ## VARIANT ## __ ## __method__ ## METHOD_NAME
...
/* Given a struct type name, a variant specification, a (possibly empty)
   variant  specification, and  a  (possibly empty)  list of  arguments:
   expand into the invocation of the API function "delete()". */
#define ccstructs_delete(STRUCT_TYPE,...)		\
  CCNAME_DELETE(STRUCT_TYPE)(__VA_ARGS__)
...
/* Given a struct type name, a variant specification, a (possibly empty)
   variant  specification, and  a  (possibly empty)  list of  arguments:
   expand into the invocation of the API function "final()". */
#define ccstructs_final(STRUCT_TYPE, VARIANT, ...)	\
  CCNAME_FINAL(STRUCT_TYPE, VARIANT)(__VA_ARGS__)

/* Given an interface type name, a  struct type name, a (possibly empty)
   variant specification, an  expression that evaluates to  a pointer to
   struct instance,  and a  (possibly empty)  list of  arguments: expand
   into the invocation of the API function "new()" that instantiates the
   interface for the struct. */
#define ccstructs_iface_new(IFACE_TYPE, STRUCT_TYPE, VARIANT, STRUCT_INST, ...)	\
  CCNAME_IFACE_NEW(IFACE_TYPE, STRUCT_TYPE, VARIANT)((STRUCT_INST), __VA_ARGS__)
